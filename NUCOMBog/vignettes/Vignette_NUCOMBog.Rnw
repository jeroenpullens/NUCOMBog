...
Peatlands play an important role in the greenhouse gas cycle of the earth, they store up to 1/3 of the earth's carbon in their soils \citep{Gorham1991}. The soils of peatlands are composed of dead organic matter, which decomposes slowly due to water saturation of the soil and the high recalcitrance of the \emph{Sphagnum} mosses. Most of the peatlands are acting as carbon sinks, so they are actively storing carbon in their soils \citep[e.g.][]{Lund2010,McVeigh2014,Humphreys2014}, while some other are acting as a carbon source \citep[e.g.][]{Pullens2016,Hendriks2007}. The stored carbon in the soil is vulnerable to climate change, due to differences in precipitation regime and change in temperature. A difference in climate can result in differences in the plant composition, due to differences in the water table depth. Other plants might invade, e.g. shrubs and trees \citep{Stine2011,Holmgren2015} and hence the carbon balance will change. It is therefore vital to understand the future of the stored carbon in the peatlands, since the reaction to climate change  can be a slow process, models are needed to simulate the fate of the carbon over years/decades.
...
An example of the structure of the folder and the data of the example can be downloaded from \url{https://github.com/jeroenpullens/NUCOMBog_data}. This data was used in the publication of \cite{Heijmans2008a}
