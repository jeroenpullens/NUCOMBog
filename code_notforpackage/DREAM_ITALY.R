...
setup_SMC <- setupNUCOM(mainDir = "/home/jeroen/NUCOM_ITALY/", climate = "clim_1766_2016_soiltemp.txt",environment = "Env_ITALY_ndep_measured.txt",inival = "Inival_ITALY.txt",start = 1766,end = 2016,startval = 2953,type = c("NEE","WTD"))
...
source(file = "/home/jeroen/Desktop/nucom/code_notforpackage/test_DREAMzs_grass.R")

priorrange <- data.frame(min=min, max = max, row.names = names)
date<-Sys.Date()

save.image("~/NUCOM_ITALY/DREAMzs_ITALY_1e6_2016_soil_meas_ndep_grass_no_shrub.RData")
