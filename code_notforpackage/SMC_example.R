...
test_smc<-smc_sampler(likelihoodParallel,clustertype = "SOCK",numCores = 10,initialParticles = parind,setup=setup_SMC, iterations =10, resampling = T, proposal = NULL, parallel="external",parameters=parind_norm,scaled=T,originalvalues=parind)
save(test_smc,"SMC_MERBLEUE_p1000_i100_rT")
