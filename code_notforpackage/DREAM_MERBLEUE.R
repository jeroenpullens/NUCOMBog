...
setup_SMC<- setupNUCOM(mainDir = "/home/jeroen/MERBLEUE_decomp/", climate = "MERBLEUE_RANDOM_soiltemp_1766_2013.txt",environment = "Env_Mer_Bleue.txt",inival = "Inival_Mer_Bleue.txt",start=1766,end=2013,type=c("NEE","WTD"),numFolders=numFolders,separate = F,startval=2797,parallel = F)
...
save.image("~/MERBLEUE_long_term/DREAMzs_1e6i_WTD_new_prior_decomp_soiltemp.RData")
