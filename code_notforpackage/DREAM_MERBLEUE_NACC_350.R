...
setup_SMC<- setupNUCOM(mainDir="/home/jeroen/Desktop/MERBLEUE_long_term/",climate="Dataset_1766-2013.txt",environment="Env_Mer_Bleue.txt",inival="Inival_Mer_Bleue_NACC_350.txt",start=1766,end=2013,type=c("NEE","WTD"),numFolders=numFolders,separate = F,startval=2797,parallel = F)
...
save.image("~/Desktop/MERBLEUE_long_term/DREAMzs_sdNEE_30_10_1e6i_WTD0_1_NORMALCLIM_NACC350.RData")

# pdf(paste("marginalplot_scaled_NORMALCLIM_NACC350",date,".pdf",sep=""))
# marginalPlot2(out2,bounds = priorrange)
# dev.off()
#
# pdf(paste("marginalplot_unscaled_NORMALCLIM_NACC350",date,".pdf",sep=""))
#  marginalPlot2(out2)
#  dev.off()
#
# pdf(paste("correlationplot_NORMALCLIM_NACC350",date,".pdf",sep=""),width=200,height = 200)
