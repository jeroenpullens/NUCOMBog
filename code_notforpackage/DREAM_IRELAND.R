...
setup_SMC<- setupNUCOM(mainDir="/home/jeroen/Desktop/IRELAND/",climate="CLIM_IRELAND_1766-2013_orig.txt",environment="Env_IRELAND_staticNdep.txt",inival="inival_IRELAND_centuries.txt",start=1766,end=2012,type=c("NEE","WTD"),numFolders=numFolders,separate = F,startval=2845,parallel = F)
...
source(file = "/home/jeroen/Desktop/code_notforpackage/test_DREAMzs_03102016.R")

save.image("~/Desktop/IRELAND/DREAMzs_sdNEE_30_10_1e6i_WTD0_1.RData")
