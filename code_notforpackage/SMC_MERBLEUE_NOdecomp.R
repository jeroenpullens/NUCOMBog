...
test_smc_nodecomp<-smc_sampler(likelihood = likelihoodParallel,clustertype = "SOCK",numCores = 10,initialParticles = parind,setup=setup_SMC, iterations =10, resampling = T, proposal = NULL, parallel="external",parameters=parind_norm,scaled=T,originalvalues=parind)

save(test_smc_nodecomp,file="test_smc_nodecomp_17112015.rData")
