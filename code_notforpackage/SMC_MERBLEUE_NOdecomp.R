...
setup_SMC<-setup(mainDir="/home/jeroen/test_package/",climate="clim_1999-2013_measured.txt",environment="Env_Mer_Bleue_1999_2013.txt",inival="Inival_Mer_Bleue.txt",start=1999,end=2013,type=c("NEE","WTD"),numFolders=10000,separate = F,startval = 1)
...
test_smc_nodecomp<-smc_sampler_mod(likelihood = likelihoodParallel,prior =prior,clustertype = "SOCK",numCores = 1,initialParticles = a,setup=setup_SMC, iterations =10, resampling = T, proposal = proposal, parallel="external",scaled=F,Logtype="classic")
