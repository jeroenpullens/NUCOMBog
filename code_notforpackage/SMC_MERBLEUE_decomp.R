...
values<-c(37,-3.764,0.204,-1.882,0.102,0.5,70,0.08,0.012,0.8,60,0.012,100,1,45,0.04,20,14,17,1,50,0.04,20,14,17,1,60,0.08,20,10,17,1,0.1)
scale<-values/values
...
save.image("~/Desktop/MERBLEUE_long_term/SMC_sdNEE_30_10_1e6i_WTD0_1.RData")
