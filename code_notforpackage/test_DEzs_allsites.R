...
values<-c(0.5,70,0.08,0.012,12,20,25,0.8,60,0.04,0.012,5,14,25,100,1,45,0.04,25,14,18,1,50,0.04,25,14,18,1,60,0.08,25,10,18,1,0.1)
min<-   0.1*values
max<-  c(2,5,5,2,0.4,1.7,1.4,1.25,5,5,2,0.4,2.2,1.4,1.67,5,5,5,1.4,1.4,2.2,5,5,5,1.4,1.4,2.2,5,5,5,1.4,1.4,2.2,10,1)*values
