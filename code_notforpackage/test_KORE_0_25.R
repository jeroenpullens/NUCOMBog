...
setup_SMC<- setupNUCOM(mainDir="/fem0/keu_pullens/MERBLEUE_long_term_0.25/",climate="Dataset_1939-2013.txt",environment="Env_Mer_Bleue.txt",inival="Inival_Mer_Bleue.txt",start=1939,end=2013,type=c("NEE","WTD"),numFolders=numFolders,separate = F,startval=721,parallel = T)
